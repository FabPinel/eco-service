                    ...
                    <form action="{{ route('addToCart', ['productId' => $product->id]) }}" method="POST" class="mt-6">
                        ...
                        <div class="mt-10 flex">
                            ...
                            <input type="number" name="quantity" value="1" min="1"
                                ...
                                class="w-10 rounded-md border border-gray-300 py-1.5 text-left text-base font-medium leading-5 text-gray-700 shadow-sm focus:border-[#1c3242] focus:outline-none focus:ring-1 focus:ring-[#1c3242] sm:text-sm mr-4"
