...
@section('content')
    ...
    @if ($message = Session::get('success'))
        <div id="successMessage"
            class="fixed top-28 right-4 w-1/3 flex border-l-8  border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md md:p-9">
            ...
            <div class="w-full">
                ...
                <a href="{{ route('panier') }}" class="text-base text-[#34D399] underline font-semibold">Voir mon
                    panier</a>
            </div>
        </div>
    @endif
