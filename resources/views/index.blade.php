    ...
    <div class="bg-white">
        ...
        <div class="relative bg-gray-900 h-screen">
            ...
            <div aria-hidden="true" class="absolute inset-0 overflow-hidden h-screen">
                <img src="https://image.noelshack.com/fichiers/2024/05/1/1706536138-hero-section-eco-service.jpg" alt=""
            ...
            <div class="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
                ...
                <p class="mt-4 text-xl text-white">Transformez votre quotidien avec notre gamme complète de produits DIY pour des solutions de nettoyage respectueuses de l'environnement. Chez Éco-Service, nous croyons en la puissance du Do It Yourself (Faites-le vous-même) pour créer des produits ménagers efficaces, écologiques et économiques..</p>
                <a href="/boutique" class="mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100">Découvrez nos solutions durables</a>
            </div>
        </div>
        ...
        <main>
            ...
            <section aria-labelledby="category-heading" class="pt-24 sm:pt-32 xl:mx-auto xl:max-w-7xl xl:px-8">
                <div class="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
                    <h2 id="category-heading" class="text-2xl font-bold tracking-tight text-gray-900">Découvrez nos produits</h2>
                                ...
                                @foreach ($productsHome as $product)
                                    <a href="{{ route('shop.productName', $product->id) }}" class="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                        <span aria-hidden="true" class="absolute inset-0">
                                            <img class="h-full w-full object-cover object-center" src="{{ asset('storage/images/' . $product->media) }}" alt="{{ $product->name }}"> 
                                        </span>
            ...
            <section aria-labelledby="social-impact-heading" class="mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-32 lg:px-8">
                <div class="relative overflow-hidden rounded-lg">
                    <div class="absolute inset-0">
                        <img src="https://image.noelshack.com/fichiers/2024/05/1/1706538116-pexels-polina-tankilevitch-3735147.jpg" alt="" class="h-full w-full object-cover object-center">
                    </div>
                    <div class="relative bg-gray-900 bg-opacity-50 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
                        <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                            ...
                            <p class="mt-3 text-xl text-white"> Choisissez une vie sans gaspillage, privilégiez le réutilisable au jetable, et faites un impact positif sur la planète. Rejoignez-nous pour un avenir plus vert et responsable. #ZéroDéchet 🌿♻️</p>
                            <a href="#" class="mt-8 block w-full rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto">Je découvre !</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section aria-labelledby="collection-heading"
                ...
                <p class="mt-4 text-base text-gray-500">Explorez l'art du DIY écologique avec nos articles pour créer des solutions durables à la maison. Faites place à la créativité et à la responsabilité environnementale ! 🌱🛠️</p>
                    ...
                    @foreach ($diyHome as $diy)
                        <a href="#" class="group block">
                            <div aria-hidden="true"
                                ...
                                <img src="{{ asset('storage/images/' . $diy->image) }}" class="h-full w-full object-cover object-center">
                            </div>
